...
const TransactionsCreate = ({ fields, selectedItem, modelName, handleChange, Validator, children }) => {
    ...
    return (
        <div>
            ...
            {children}
            <Button onClick={requestPost} variant="contained">Insertar Registro</Button>
        </div>
    )
}
